   ...
   return (
      <Container>
         <div className="min-h-[700px] md:min-h-[652px] flex items-center">
            <div className="grid gap-y-6 justify-items-start">
               <p className="text-6xl md:text-8xl leading-[60px] md:leading-[130px]">
                  Hi, I&apos;m <span className="text-[#ACADB0]">Ayomide!</span>
               </p>
               <p className="text-lg md:text-2xl font-light leading-[36px] md:leading-[43px] text-justify lg:me-[267px]">
